#pragma checksum "C:\Users\YowaneHaku\source\repos\ShindaTest2\ShindaTest2\Views\Shinda\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1a0be6fd040dcbc8c5c32730c3ddee693076b43d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1a0be6fd040dcbc8c5c32730c3ddee693076b43d", @"/Views/Shinda/Index.cshtml")]
        ...
        <div class=""row mb-4"">
            ...
            <div class=""col-4"">
                <select class=""form-control"">
                    ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1a0be6fd040dcbc8c5c32730c3ddee693076b43d5931", async() => {
                WriteLiteral("請選擇...");
            }
            );
...
#nullable disable
            WriteLiteral("                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "1a0be6fd040dcbc8c5c32730c3ddee693076b43d7409", async() => {
#nullable restore
...
<script>
            ...
            if(req.status == 200 && req.readyState == 4){
                 ...
                 res = JSON.parse(req.response);
                    ...
                    for(i = 0;i<res.length;i++){
                        $('tbody').append(`<tr><td>${res[i].cID}</td><td>${res[i].showDt}</td><td>${res[i].cName}</td><td>${res[i].showTot}</td><td><a href=""javascript:void(0)"" onclick=""ttt()"">查看訂單</a></td></tr>`)
                    }
    ...
    function get(value){
        ...
        for(j = 0;j < res.length;j++){
            if(res[j].cID.indexOf(value.toUpperCase");
                WriteLiteral(@"()) != -1){
                 $('tbody').append(`<tr><td>${res[j].cID}</td><td>${res[j].showDt}</td><td>${res[j].cName}</td><td>${res[j].showTot}</td><td><a href=""javascript:void(0)"" onclick=""ttt()"">查看訂單</a></td></tr>`)
            }
        }
        ...
        for(j = 0;j < res.length;j++){
            if(res[j].cName.indexOf(value.toUpperCase()) != -1){
                 $('tbody').append(`<tr><td>${res[j].cID}</td><td>${res[j].showDt}</td><td>${res[j].cName}</td><td>${res[j].showTot}</td><td><a href=""javascript:void(0)"" onclick=""ttt()"">查看訂單</a></td></tr>`)
            }
        }
    ...
    document.getElementById('buy').addEventListener('click',function(){
        ...
        req.onreadystatechange = function(){
            if(req.status == 200 && req.readyState == 4){
                ...
                ");
                WriteLiteral(@"if(res.Msg != undefined){
                    alert(res.Msg);
                }
                else{
